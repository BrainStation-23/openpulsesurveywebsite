...
const Hero = () => {
  return (
    <div className="relative isolate overflow-hidden bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* Simplified background using CSS gradients instead of complex SVG */}
      <div className="absolute inset-0 -z-10 overflow-hidden bg-gray-50">
        <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-blue-600/10 ring-1 ring-blue-50"></div>
      </div>
    </div>
  );
};
