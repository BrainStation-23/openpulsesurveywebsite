        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
          <div className="col-span-1 md:col-span-3 lg:col-span-2">
            ...
            <div className="mt-6 flex space-x-6">
              ...
              <a href="https://github.com/BrainStation-23/openpulsesurvey" className="text-gray-500 hover:text-blue-500">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="#" className="text-base text-gray-600 hover:text-blue-500">About Us</a>
              </li>
              <li>
                <Link to="/contact" className="text-base text-gray-600 hover:text-blue-500">Contact</Link>
              </li>
              <li>
                <a href="#" className="text-base text-gray-600 hover:text-blue-500">Privacy Policy</a>
              </li>
            </ul>
          </div>
        </div>
